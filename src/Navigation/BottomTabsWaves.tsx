        ...
        options={{
          ...
          tabBarIcon: ({ref}) => (
            <Lottie
              ref={ref}
              loop={false}
              source={require('../assest/home.icon.json')}
              style={styles.icon}
            />
          ),
        }}
        ...
        options={{
          ...
          tabBarIcon: ({ref}) => (
            <Lottie
              ref={ref}
              loop={false}
              source={require('../assest/upload.icon.json')}
              style={styles.icon}
            />
          ),
        }}
        ...
        options={{
          ...
          tabBarIcon: ({ref}) => (
            <Lottie
              ...
              loop={false}
              style={styles.icon}
              source={require('../assest/chat.icon.json')}
            />
          ),
        }}
        component={PlaceholderScreen}
        ...
        options={{
          ...
          tabBarIcon: ({ref}) => (
            <Lottie
              ref={ref}
              loop={false}
              source={require('../assest/settings.icon.json')}
              style={styles.icon}
            />
          ),
        }}
...
const PlaceholderScreen = () => {
  return <View style={{flex: 1, backgroundColor: '#123456'}} />;
};
...
export default BottomTabsWaves;
